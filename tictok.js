...
let genericUserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36";
...
function selector(j, h, id) {
    ...
    if (t != undefined && t.length < 3) return false;
    return t;
}
...
export async function tictok(url) {

    let obj = {postId:'',url:url,host:'tiktok'};
    const regex = /video\/(\d+)/;
...
// console.log(await tictok('https://www.tiktok.com/@harrisonfraser/video/7214413540348792065?is_from_webapp=1&sender_device=pc'));
